...
BEGIN
  ...
  -- Supplier zone fees (simplified - one flat fee per zone, no vehicle differentiation)
  -- Suppliers handle their own logistics, so vehicle selection is unnecessary
  INSERT INTO supplier_zone_fees (supplier_id, zone, base_fee_jod) VALUES
    -- Supplier 1 fees
    ('d1111111-1111-1111-1111-111111111111', 'zone_a', 10.00),
    ('d1111111-1111-1111-1111-111111111111', 'zone_b', 15.00),

    -- Supplier 2 fees (slightly cheaper)
    ('d2222222-2222-2222-2222-222222222222', 'zone_a', 9.00),
    ('d2222222-2222-2222-2222-222222222222', 'zone_b', 14.00),

    -- Supplier 3 fees (Aqaba pricing)
    ('d3333333-3333-3333-3333-333333333333', 'zone_a', 7.00),
    ('d3333333-3333-3333-3333-333333333333', 'zone_b', 12.00);
